...
class CanonFusion():
    ...
    def forward(self, input_frames, input_masks, input_normals, smpl_params, smpl_meshes, posed_meshes=None, canon_meshes=None, output_dir=None, cam_params=None, config=None):
        ...
        smpl_mesh, smpl_infos, full_poses, smpl_models = load_smpl_info(smpl_params, self.smpl_type, self.smpl_data, self.tpose)

        if self.use_initial_mesh and self.tpose: # refine intiial canonicalized mesh
        ...
        if config.canonfusion.use_mesh:
            ...
            ### TODO: Need to be revised! --> camera setting ###
